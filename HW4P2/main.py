...
from modules.utils import set_random_seed, plot_attention
...
########## 수정
# test, val transcript max length is 600
...
attention = Attention(encoder_hidden_size, decoder_output_size, 128)
summary(attention, x.to(DEVICE), lx, y.to(DEVICE))
